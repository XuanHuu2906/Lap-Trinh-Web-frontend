...
const INITIAL_JOBS_MOCK: AdminJob[] = [
  {
    ...
    description:
      "Xây dựng kiến trúc hệ thống backend microservices xử lý hàng triệu request đồng thời. Tích hợp thanh toán trực tuyến, quản lý bảo mật và tối ưu cơ sở dữ liệu lớn.",
    requirements:
      "Tối thiểu 4 năm kinh nghiệm làm việc với Node.js, NestJS và SQL Server. Có kinh nghiệm với Docker, Redis và thiết kế hệ thống phân tán.",
  ...
  },
  {
    ...
    companyLogo:
      "https://images.unsplash.com/photo-1516321318423-f06f85e504b3?auto=format&fit=crop&w=80&q=80",
    title: "Product Owner (E-commerce Platform)",
    description:
      "Chịu trách nhiệm nghiên cứu thị trường, lập kế hoạch và định hình sản phẩm. Quản lý backlog, phối hợp với dev team và các bên liên quan để đưa ra tính năng mới đúng hạn.",
    requirements:
      "3 năm kinh nghiệm PO/PM trong mảng Thương mại điện tử hoặc Fintech. Khả năng tư duy logic tốt, giao tiếp lưu loát và hiểu biết sâu sắc về hành vi người dùng.",
  ...
  },
  {
    ...
    companyLogo:
      "https://images.unsplash.com/photo-1554774853-aae0a22c8aa4?auto=format&fit=crop&w=80&q=80",
    title: "UI/UX Designer (Mobile Banking app)",
    description:
      "Nghiên cứu hành vi người dùng, vẽ wireframe, thiết kế giao diện ứng dụng ngân hàng số trực quan, nâng cấp trải nghiệm giao dịch tài chính nhanh gọn.",
    requirements:
      "Kinh nghiệm thiết kế Figma tối thiểu 2 năm, ưu tiên ứng viên từng làm tài chính hoặc thiết kế ứng dụng thanh toán ngân hàng.",
  ...
  },
  {
    ...
    companyLogo:
      "https://images.unsplash.com/photo-1542744094-3a31f103e35f?auto=format&fit=crop&w=80&q=80",
    title: "Data Analyst (Marketing Department)",
    description:
      "Phân tích hiệu suất chiến dịch quảng cáo, truy vấn SQL, trực quan hóa dữ liệu hiệu quả nhằm báo cáo cho các quyết định tối ưu ngân sách marketing.",
    requirements:
      "Kỹ năng SQL xuất sắc, biết Tableau hoặc PowerBI. Kinh nghiệm Marketing DA là lợi thế lớn.",
  ...
  },
  {
    ...
    companyLogo:
      "https://images.unsplash.com/photo-1621761191319-c6fb62004040?auto=format&fit=crop&w=80&q=80",
    title: "Solidity Smart Contract Auditor",
    description:
      "Thực hiện kiểm thử hợp đồng thông minh blockchain cho các dự án Web3 của công ty nhằm đảm bảo tính an toàn bảo mật, tránh thất thoát tài sản.",
    requirements:
      "Đã từng kiểm duyệt (Audit) ít nhất 3 dự án DeFi lớn, am hiểu sâu sắc về ERC-20, ERC-721 và lỗ hổng bảo mật Solidity.",
    ...
    rejectionReason:
      "Nội dung tuyển dụng chứa từ khóa liên quan đến đầu tư tài chính tiền số rủi ro cao, không phù hợp chính sách tin đăng của HireArch.",
  },
];
        ...
        {filteredJobs.length > 0 ? (
          <div className="divide-y divide-slate-150 text-left">
            {filteredJobs.map((job) => (
              <div
                key={job.id}
                className="p-6 hover:bg-slate-50/50 transition-all flex flex-col md:flex-row md:items-start md:justify-between gap-6"
              >
                {/* Left info */}
                <div className="flex items-start gap-4">
                  <img
                    src={job.companyLogo}
                    alt={job.companyName}
                    className="w-12 h-12 rounded-sm border border-slate-200/80 shadow-3xs shrink-0 object-cover"
                  />
                  <div>
                    ...
                    <div className="flex items-center gap-2 mt-4">
                      ...
                      <Badge
                        variant="outline"
                        className="text-indigo-700 border-indigo-200 bg-indigo-50/30"
                      >
                    ...
                    {activeTab === "rejected" && job.rejectionReason && (
                      <div className="bg-red-50 border border-red-100/70 p-3 mt-4 rounded-sm flex items-start gap-2.5">
                        ...
                        <div>
                          <span className="text-[10px] font-extrabold text-red-700 block uppercase tracking-wider">
                            Lý do từ chối duyêt bài
                          </span>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-xs animate-fade-in text-left">
          <div className="bg-white border border-slate-200 rounded-sm w-full max-w-2xl shadow-xl overflow-hidden animate-slide-up h-[90vh] flex flex-col">
            ...
            <div className="px-6 py-5 border-b border-slate-100 flex items-center justify-between shrink-0 bg-slate-50">
              <div className="flex items-center gap-3">
                <img
                  ...
                  className="w-10 h-10 border border-slate-200 rounded-sm shrink-0 object-cover"
                />
                <div>
            ...
            <div className="p-6 overflow-y-auto flex-1 space-y-6 text-slate-700">
              <div>
                <span className="text-[9px] font-black text-slate-400 tracking-widest uppercase block mb-1">
                  TIÊU ĐỀ CÔNG VIỆC
                </span>
                <h1 className="text-xl font-black text-slate-950 leading-snug">
                  {previewingJob.title}
                </h1>
              ...
              <div className="grid grid-cols-2 gap-4 border-y border-slate-100 py-4">
                <div>
                  <span className="text-[10px] font-black text-slate-400 block tracking-wider uppercase mb-1">
                    ĐỊA ĐIỂM
                  </span>
              ...
              <div>
                <span className="text-[10px] font-black text-slate-400 block tracking-widest uppercase mb-2">
                  MÔ TẢ CÔNG VIỆC
                </span>
            ...
            {/* Bottom buttons */}
            <div className="px-6 py-4 bg-slate-50 border-t border-slate-100 shrink-0 flex items-center justify-between gap-3">

  ...
  return (
    <div className="space-y-6 animate-fade-in font-sans text-slate-800">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-xl font-black text-slate-900 tracking-tight mt-1.5 font-sans uppercase">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <Card className="p-5 flex items-center justify-between border-slate-200 rounded-sm shadow-2xs bg-white">
          <div>
            <CardDescription className="uppercase tracking-wider font-extrabold text-[10px] text-slate-400">
              YÊU CẦU CHỜ DUYỆT
            </CardDescription>
          ...
          <div className="flex items-center gap-3 w-full sm:w-auto shrink-0">
            ...
            <div className="flex items-center gap-1.5 border border-slate-200 px-2.5 h-9 bg-white rounded-sm">
              ...
              <select
                ...
                className="text-xs font-bold text-slate-650 outline-none bg-transparent cursor-pointer"
              >
        ...
        {isLoading ? (
          ...
          <div className="py-16 text-center">
            ...
            <Button
              ...
              size="sm"
              onClick={fetchJobs}
              className="mt-3 border-red-200 text-red-600 hover:bg-red-50 font-bold text-xs h-9 px-4 cursor-pointer"
            >
              Thử lại
            </Button>
          </div>
              ...
              >
                    ...
                    {activeTab === "rejected" && job.rejectionReason && (
                      <div className="bg-red-50 border border-red-100/70 p-3 mt-4 rounded-sm flex items-start gap-2.5">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-red-650 font-semibold leading-relaxed mt-1">
                            {job.rejectionReason}
                          </p>
                        </div>
                      </div>
                ...
                <div className="flex items-center gap-2 self-end md:self-start shrink-0">
                  <Button
                    ...
                    className="h-9 w-9 border border-slate-200 text-slate-500 hover:text-slate-800 hover:border-slate-350 bg-white cursor-pointer"
                  ...
                  <Button
                    ...
                    className="h-9 w-9 border border-slate-200 text-slate-450 hover:text-red-650 hover:border-red-200 bg-white cursor-pointer"
                  ...
                  {activeTab === "pending" && (
                    <>
                      <Button
                        ...
                        className="bg-slate-900 hover:bg-slate-800 text-white font-bold text-xs cursor-pointer h-9 px-4"
                      >
                      ...
                      <Button
                        ...
                        className="border-red-200 text-red-600 hover:bg-red-50 hover:border-red-300 hover:text-red-700 font-bold text-xs h-9 px-3.5 cursor-pointer"
                      >
          ...
          <div className="bg-white border border-slate-200 rounded-sm w-full max-w-lg shadow-xl overflow-hidden animate-slide-up text-left">
            ...
            <div className="px-6 py-4 bg-slate-50 border-t border-slate-100 flex items-center justify-end gap-3">
              <Button
                ...
                size="sm"
                onClick={() => setIsRejectingModalOpen(false)}
                className="text-slate-500 hover:text-slate-850 font-bold text-xs h-9 px-4 cursor-pointer"
              >
                Hủy bỏ
              </Button>
          ...
          <div className="bg-white border border-slate-200 rounded-sm w-full max-w-2xl shadow-xl overflow-hidden animate-slide-up h-[90vh] flex flex-col">
            ...
            <div className="p-6 overflow-y-auto flex-1 space-y-6 text-slate-700">
              ...
              <div>
                ...
                <p className="text-xs font-semibold leading-relaxed text-slate-650 bg-slate-50 p-4 rounded-sm border border-slate-150 whitespace-pre-wrap">
            ...
            <div className="px-6 py-4 bg-slate-50 border-t border-slate-100 shrink-0 flex items-center justify-between gap-3">
              ...
              <div className="flex gap-2">
                <Button
                  ...
                  size="sm"
                  onClick={() => setPreviewingJob(null)}
                  className="text-slate-500 hover:text-slate-800 font-bold text-xs h-9 px-4 cursor-pointer"
                >
                  Đóng lại
                </Button>
                ...
                {previewingJob.status === "draft" && (
                  <>
                    <Button
                      ...
                      className="bg-slate-900 hover:bg-slate-800 text-white font-bold text-xs h-9 px-4 cursor-pointer"
                    >
                      Phê duyệt ngay
                    </Button>
                    ...
                    <Button
                      ...
                      className="border-red-200 text-red-600 hover:bg-red-50 font-bold text-xs h-9 px-4 cursor-pointer"
                    >
                      Từ chối tin
                    </Button>
                  </>

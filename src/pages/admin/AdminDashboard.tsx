      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-slate-500 font-medium mt-1">
            Báo cáo thời gian thực và quản lý các hoạt động tuyển dụng trên hệ
            thống.
          </p>
        </div>
      </div>
          ...
          return (
            ...
            >
              <div className="flex items-center justify-between mb-4">
                ...
                <div
                  className={`w-8 h-8 ${kpi.bgColor} ${kpi.color} rounded-sm flex items-center justify-center`}
                >
              ...
              <div className="flex items-end justify-between">
                ...
                <div
                  className={`flex items-center text-[10px] font-bold ${kpi.isPositive ? "text-emerald-600" : "text-rose-600"}`}
                >
                  {kpi.isPositive ? (
              ...
              return (
                ...
                >
                  <div className="flex items-start gap-3">
                    <div className="w-8 h-8 bg-slate-50 border border-slate-200/80 rounded-sm flex items-center justify-center shrink-0 mt-0.5">
                  ...
                  <div className="self-start sm:self-auto">
                    <span
                      className={`inline-flex px-2.5 py-1 border text-[10px] font-bold uppercase rounded-2xs ${act.badgeColor}`}
                    >
                      {act.badgeText}
                    </span>
                  </div>
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <div className="w-full h-2 bg-amber-500 rounded-sm overflow-hidden flex">
                  <div
                    className="w-[95%] h-full bg-indigo-600"
                    title="Ứng viên (95%)"
                  ></div>
                  <div
                    className="w-[5%] h-full bg-amber-500"
                    title="Doanh nghiệp (5%)"
                  ></div>
                </div>
              ...
              <div>
                ...
                <div className="w-full h-2 bg-slate-100 rounded-sm overflow-hidden flex">
                  <div
                    className="w-[84%] h-full bg-emerald-500"
                    title="Đã duyệt (84%)"
                  ></div>
                  <div
                    className="w-[12%] h-full bg-amber-500"
                    title="Chờ duyệt (12%)"
                  ></div>
                  <div
                    className="w-[4%] h-full bg-rose-500"
                    title="Khác (4%)"
                  ></div>
                </div>
                <div className="flex justify-between items-center mt-1">
              ...
              <div>
                ...
                <div className="w-full h-2 bg-slate-100 rounded-sm overflow-hidden flex">
                  <div
                    className="w-[72%] h-full bg-emerald-500"
                    title="Sử dụng mẫu chuẩn (72%)"
                  ></div>
                  <div
                    className="w-[28%] h-full bg-slate-300"
                    title="Tải lên trực tiếp (28%)"
                  ></div>
                </div>
                <div className="flex justify-between items-center mt-1">
                  <span className="text-[9px] text-emerald-600 font-bold">

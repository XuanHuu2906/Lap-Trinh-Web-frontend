    ...
    <div className="flex-1 p-8">
      <div className="mb-6">
        ...
        <p className="text-[14px] text-slate-500 mt-1">
          Tạo một vị trí công việc mới trên hệ thống HireArch Enterprise.
        </p>
      </div>
              ...
              {[
                {
                  ...
                  desc: "Sử dụng chức danh công việc tiêu chuẩn ngành để ứng viên dễ tìm thấy (vd: Frontend Engineer thay vì Code Ninja).",
                },
                {
                  color: "bg-amber-500",
                  title: "Mô tả chi tiết",
                  desc: "Nêu bật những thách thức, dự án và công cụ mà ứng viên sẽ làm việc hàng ngày.",
                },
                {
                  color: "bg-emerald-500",
                  title: "Minh bạch mức lương",
                  desc: "Các tin tuyển dụng công khai khoảng lương thu hút lượng ứng viên chất lượng cao hơn 30%.",
                },
              ].map((tip, i) => (
                <div key={i} className="flex items-start gap-3">
                  <div
                    className={`w-5 h-5 rounded-full ${tip.color} flex items-center justify-center shrink-0 mt-0.5`}
                  >
                    <svg

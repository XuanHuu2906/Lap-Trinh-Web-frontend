...
const urgentTasks = [
  {
    text: "Phê duyệt yêu cầu tuyển dụng từ bộ phận IT.",
    deadline: "Hạn: Hôm nay",
  },
  {
    text: "Đánh giá 15 ứng viên vòng CV cho vị trí Sales.",
    deadline: "Hạn: Ngày mai",
  },
  {
    text: 'Gia hạn tin tuyển dụng "Marketing Executive".',
    deadline: "Hạn: Thứ Sáu",
  },
];
      ...
      <div className="flex items-start justify-between mb-8">
        <div>
          ...
          <p className="text-[14px] text-slate-500 mt-1">
            Theo dõi hiệu suất chiến dịch và quản lý ứng viên mới trong hệ
            thống.
          </p>
        </div>
      ...
      <div className="grid grid-cols-4 gap-4 mb-8">
        ...
        <div className="bg-white border border-slate-200 p-5">
          ...
          <div className="flex items-end gap-2">
            ...
            <span className="text-[11px] text-emerald-600 font-semibold mb-1">
              +54 tuần này
            </span>
          </div>
        </div>
            ...
            <tbody>
              {applicants.map((a, i) => (
                ...
                >
                  ...
                  <td className="px-6 py-4">
                    <span
                      className={`inline-block text-[11px] font-semibold px-2 py-1 rounded-sm ${a.statusColor}`}
                    >
                      {a.status}
                    </span>
                  </td>
                  ...
                  <td className="px-6 py-4">
                    <button className="text-[12px] text-slate-500 border border-slate-200 px-3 py-1 hover:bg-slate-100 transition-colors">
                      Xem
                    </button>
                  </td>
                </tr>

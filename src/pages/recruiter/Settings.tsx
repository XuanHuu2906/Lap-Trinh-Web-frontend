  ...
  return (
    <div className="flex-1 p-8">
      ...
      <div className="flex gap-6 items-start">
        ...
        {/* Left settings menu */}
        <div className="w-[200px] flex-shrink-0 bg-white border border-slate-200">
          ...
          {activeTab === 'Hồ sơ công ty' && (
            <div>
              <div className="px-8 pt-7 pb-5 border-b border-slate-100">
                ...
                <p className="text-[13px] text-slate-500 mt-1">Thông tin này sẽ được hiển thị công khai trên các tin tuyển dụng của bạn.</p>
              </div>
              ...
              <div className="px-8 py-7 space-y-6">
                ...
                <div className="flex items-start gap-5 p-4 border border-slate-200 bg-slate-50">
                  <div className="w-16 h-16 bg-blue-100 border border-slate-200 flex items-center justify-center flex-shrink-0 overflow-hidden">
                    {logoPreview ? (
                      <img src={logoPreview} alt="Logo" className="w-full h-full object-cover" />
                    ) : (
                      <div className="w-full h-full bg-gradient-to-br from-blue-400 to-blue-600 flex items-center justify-center">
                        <span className="text-white text-[10px] font-bold text-center leading-tight px-1">COMPA<br />NY</span>
                      </div>
                    )}
                  </div>
                  <div>
                    <label className="block text-[11px] font-bold text-slate-500 uppercase tracking-widest mb-1">Logo doanh nghiệp</label>
                    <p className="text-[12px] text-slate-400 mb-3">Định dạng JPG, PNG. Kích thước tối đa 2MB. Tỉ lệ 1:1.</p>
                    <button
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-[11px] font-bold text-slate-500 uppercase tracking-widest mb-2">Lĩnh vực hoạt động</label>
                  ...
                  <div>
                    <label className="block text-[11px] font-bold text-slate-500 uppercase tracking-widest mb-2">Quy mô nhân sự</label>
                    <div className="relative">
                      <select
                        value={companySize}
                ...
                <div>
                  ...
                  <div className="flex">
                    <span className="h-11 px-4 border border-r-0 border-slate-200 bg-slate-50 text-[13px] text-slate-500 flex items-center flex-shrink-0">
                      https://
                    </span>
                    <input
                      type="text"
              ...
              <div className="px-8 py-5 border-t border-slate-100 flex items-center justify-end gap-3">
                <button
                  onClick={() => {
                    ...
                    setDescription('TechNova Solutions là nhà cung cấp hàng đầu các giải pháp chuyển đổi số cho doanh nghiệp vừa và nhỏ. Chúng tôi tập trung vào việc xây dựng các nền tảng SaaS có tính bảo mật cao và dễ dàng mở rộng.');
                    setLogoPreview(null);
                  }}

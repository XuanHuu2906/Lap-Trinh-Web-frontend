...
export function LoginPage() {
  return (
    <section className="flex flex-col items-center justify-center min-h-screen bg-[#f1f5f9] font-sans p-6">
      ...
      {/* Login Card */}
      <div className="w-full max-w-[560px] bg-white border border-slate-200 shadow-sm overflow-hidden">
        {/* Top dark border */}
        <div className="h-[3px] bg-[#1e293b] w-full"></div>

        <div className="px-16 pt-14 pb-12">
          <div className="text-center mb-8">
            <h2 className="text-[44px] font-black mb-2 leading-none" style={{ color: '#0f172a' }}>
              Đăng nhập
            </h2>
          ...
          <div className="bg-[#fff1f2] border border-red-100 p-3 rounded-sm flex items-start gap-3 mb-7">
            ...
            <div>
              <p className="text-red-600 font-bold text-[13px] leading-snug">Đăng nhập thất bại</p>
        ...
        <div className="bg-[#f8fafc] border-t border-slate-100 px-10 py-6 flex items-center justify-center gap-5">
          ...
          <div className="flex items-center gap-4">
            <Link to="/register-candidate" className="text-[16px] font-semibold text-slate-700 hover:text-black transition-colors">
              Ứng viên
            </Link>
            <span className="text-slate-300">|</span>
            <Link to="/register-employer" className="text-[16px] font-semibold text-slate-700 hover:text-black transition-colors">
              Nhà tuyển dụng
            </Link>
          </div>
        </div>
      ...
      <div className="mt-10 text-center">
        <p className="text-[12px] text-slate-400 mb-2">© 2024 HireArch Enterprise. All rights reserved.</p>
        <div className="flex items-center justify-center gap-4">
          <button className="text-[12px] text-slate-400 hover:text-slate-600 transition-colors">Bảo mật</button>
          <span className="text-slate-300 text-[10px]">•</span>
          <button className="text-[12px] text-slate-400 hover:text-slate-600 transition-colors">Điều khoản</button>
          <span className="text-slate-300 text-[10px]">•</span>
          <button className="text-[12px] text-slate-400 hover:text-slate-600 transition-colors">Trợ giúp</button>
        </div>
      </div>
    </section>
  );

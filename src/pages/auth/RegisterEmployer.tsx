      ...
      <div className="bg-linear-to-b from-slate-900 to-[#10264f] text-white p-10 flex flex-col justify-between">
        ...
        <div>
          ...
          <p className="mt-6 text-white/60 text-base leading-7 max-w-xs text-left">
            Nền tảng tuyển dụng chuyên nghiệp dành cho doanh nghiệp. Đăng tin
            tuyển dụng và tiếp cận ứng viên phù hợp với quy trình tối ưu và bảo
            mật cao.
          </p>
        </div>
          ...
          <div className="space-y-5">
            ...
            <div className="flex items-start gap-3">
              <input
                type="checkbox"
                id="terms"
                className="mt-1 w-4 h-4 border border-neutral-300 accent-slate-800 cursor-pointer shrink-0"
              />
              <label
                htmlFor="terms"
                className="text-[13px] text-slate-500 leading-relaxed cursor-pointer"
              >
                Tôi đồng ý với{" "}
                <span className="text-slate-700 font-semibold underline cursor-pointer">
                  Điều khoản dịch vụ
                </span>{" "}
                và{" "}
                <span className="text-slate-700 font-semibold underline cursor-pointer">
